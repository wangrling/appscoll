...
import com.android.home.threelibs.testing.espresso.CustomAdapter;
import com.android.home.threelibs.testing.espresso.RecyclerViewActivity;
...
public class RecyclerViewTest {
    ...
    public void scrollToItemBelowFold_checkItsText() {
        ...
        // Match the text in an item below the fold and check that is's displayed.
        String itemElementText = getApplicationContext().getResources()
                .getString(R.string.item_element_text) + String.valueOf(ITEM_BELOW_THE_FOLD);
