 ...
 *     {@link com.android.home.syncadapter.provider.FeedProvider}. This content provider
 *     is automatically populated by {@link SyncService}.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 *     If the content provider doesn't return any data, then the first sync hasn't run yet.
 * </p>
 *
 * <p>
 *     If the content provider doesn't return any data, then the first sync hasn't run yet.
 *     The sync adapter assumes data exists in the provider once a sync has run. If your app
 *     doesn't work like this, you should add a flag that notes if a sync has run, so you can
 *     differentiate between "no available data" and "no initial sync", and display this in the UI.
 * </p>
 *
 * <p>
...
public class EntryListFragment extends ListFragment
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter.setViewBinder(new SimpleCursorAdapter.ViewBinder() {
            ...
            public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
                if (columnIndex == COLUMN_PUBLISHED) {
     ...
     *
     * <p>
     *     Loaders do queries in a background thread. The also provide a ContentObserver that is
     *     triggered when data in the content provider changes
     *
     *     When the sync adapter update the content provider, the ContentObserver respond by resetting the
     *     loader then reloading it.
     * </p>
     */
    @NonNull
    @Override
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.sync_adapter_menu, menu);
    }
    ...
    /**
     * Sets the state of the Refresh button. If a sync is active, turn on the ProgressBar widget.
        ...
        public void onStatusChanged(int which) {
            getActivity().runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    // Set the state of the refresh button according.
