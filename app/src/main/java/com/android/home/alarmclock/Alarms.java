...
public class Alarms {
    ...
    public static final String ALARM_ALERT_ACTION = "com.android.home.alarmclock.ALARM_ALERT";
    ...
    public static Alarm calculateNextAlert(final Context context) {
        ...
        // 开启的闹钟。
        Cursor cursor = getFilteredAlarmCursor(context.getContentResolver());
    ...
    /**
     * Disables non-repeating alarms that has passed Called at boot.
     */
    public static void disableExpiredAlarms(final Context context) {
        Cursor cur = getFilteredAlarmCursor(context.getContentResolver());
        long now = System.currentTimeMillis();
    ...
    public static void setNextAlert(final Context context) {
        if (!enableSnoozeAlert(context)) {
            ...
            if (alarm != null) {
                Log.v("setNextAlert alarm time = " + alarm.time);
    ...
    private static void enableAlert(Context context, final Alarm alarm,
        ...
        Log.v("AlarmManager set atTimeInMillis = " + atTimeInMillis);
        Log.v("System time in millis =" + System.currentTimeMillis());
        Log.v("Diff time = " + (atTimeInMillis - System.currentTimeMillis()) / 1000);
    ...
    private static void setStatusBarIcon(Context context, boolean enabled) {
        // ACTION_ALARM_CHANGED app没有办法使用。
