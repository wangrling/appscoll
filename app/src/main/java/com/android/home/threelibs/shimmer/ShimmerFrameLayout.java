package com.android.home.threelibs.shimmer;
...
/**
 * Shimmer is an Android library that provides an easy way to add a shimmer effect
 * to any {@link android.view.View}. It is useful as an unobtrusive loading
 * indicator, and was originally developed for Facebook Home.
 */
