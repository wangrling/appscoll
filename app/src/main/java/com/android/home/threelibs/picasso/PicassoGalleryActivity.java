...
public class PicassoGalleryActivity extends PicassoActivity {

    private static final int GALLERY_REQUEST = 9391;
    private static final String KEY_IMAGE = "com.android.guide.picasso:image";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.picasso_gallery_activity);
    ...
    private void loadImage() {
        ...
        Picasso.get().load(image).fit().centerInside().into(imageView, new Callback.EmptyCallback() {
