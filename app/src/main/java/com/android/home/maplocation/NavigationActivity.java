...
public class NavigationActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        startPoint = new LatLng(40.047416,116.312143);
        endPoint = new LatLng(40.048424, 116.313513);

        /*构造导航起终点参数对象*/
        bikeParam = new BikeNaviLaunchParam().stPt(startPoint).endPt(endPoint);
        walkParam = new WalkNaviLaunchParam().stPt(startPoint).endPt(endPoint);
    }
    ...
    public void initOverlay() {
        ...
        mBaiduMap.setOnMarkerDragListener(new BaiduMap.OnMarkerDragListener() {
            ...
            public void onMarkerDragEnd(Marker marker) {
                ...
                bikeParam.stPt(startPoint).endPt(endPoint);
                walkParam.stPt(startPoint).endPt(endPoint);
            }
