...
public class BatchStepSensorFragment extends Fragment implements OnCardClickListener {
    ...
    /**
     * Register a {@link SensorEventListener} for the sensor and max batch delay.
    ...
    /**
     * Records the state of the application into the {@link Bundle}.
     *
     * @param outState
     */
    @Override
    ...
    private void showIntroCard() {
        Card c = new Card.Builder(this, CARD_INTRO)
                .setTitle(getString(R.string.step_intro_title))
                .setDescription(getString(R.string.step_intro_message))
                .build(getActivity());
