...
import static com.android.home.Home.APP_SERVER;
...
public class RemoteJSONSource implements MusicProviderSource {
    ...
    private static final String TAG =
            LogHelper.makeLogTag(RemoteJSONSource.class);

    protected static final String CATALOG_URL =
            APP_SERVER + "audiolibrary/music.json";
    ...
    private MediaMetadata buildFromJSON(JSONObject json, String basePath) throws JSONException {
        ...
        /**
         * MediaMetadata不允许包括自定义的元素。
         * 使用MediaMetadata.METADATA_KEY_DISPLAY_DESCRIPTION代替MusicProviderSource.CUSTOM_METADATA_TRACK_SOURCE.
         */
        return new MediaMetadata.Builder()
                .putString(MediaMetadata.METADATA_KEY_MEDIA_ID, id)
                .putString(MediaMetadata.METADATA_KEY_DISPLAY_DESCRIPTION, source)
