...
import com.android.home.pixeldungeon.levels.painters.*;
import com.android.home.pixeldungeon.utils.*;
...
public abstract class RegularLevel extends Level {
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		Collection<Bundlable> bundlables = bundle.getCollection("rooms");
		for (Bundlable bundlable : bundlables) {
			rooms.add((Room) bundlable);
		}
