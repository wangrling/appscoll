package com.android.home.soundrecorder;
...
public class VUMeter extends View {
    ...
    void init(Context context) {
        Drawable background = context.getResources().getDrawable(R.drawable.vumeter, null);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final float maxAngle = (float)Math.PI / 8 * 7;
