...
class PhotoDecodeRunnable implements Runnable {
     ...
     *
     * @param photoTask The PhotoTask, which implements ImageDecoderRunnableCallback
     */
    ...
    public void run() {
        ...
        try {
            ...
            /**
             * Sets the desired image height and width based on the ImageView being created.
             */
            ...
            /**
             * First pass of decoding to get scaling and sampling parameters from the image.
             */
            ...
            /**
             * This does the actual decoding of the buffer. If the decode encounters an
             * out-of-memory error, it may throw and Exception or an Error, both of which
             * need to be handled. Once the problem is handled, the decode is re-tried.
             */
            ...
            for (int i = 0; i < NUMBER_OF_DECODE_TRIES; i++) {
                try {
                     ...
                     * necessary. Notice that collection may or may not occur.
                     */
