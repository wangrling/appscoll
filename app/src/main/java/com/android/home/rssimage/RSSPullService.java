...
public class RSSPullService extends IntentService {
    ...
    protected void onHandleIntent(Intent workIntent) {
        ...
        Log.d(LOG_TAG, "RSSPullService onHandleIntent");
        ...
        try {
            ...
            /*
            文件保存到手机上成功。
            File rssFile = new File(Environment.getExternalStorageDirectory(), "rssFile.txt");
            InputStream inputStream = localURLConnection.getInputStream();
            FileWriter outputStream = new FileWriter(rssFile);
