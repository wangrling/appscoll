...
public class AlertDialogFragment extends DialogFragment implements
    ...
    public static void showMessageDialog(Activity activity, @StringRes int title,
        ...
        showMessageDialog(activity, title != 0 ? activity.getString(title): null,
                activity.getString(message), positiveButtonLabel != 0 ? activity.getString(positiveButtonLabel) : null,
                tag);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final TextView messageView = (TextView) inflater.inflate(
                R.layout.calculator_dialog_message, null   /* root */);
